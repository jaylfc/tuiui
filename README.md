...
# assistant_command = "opencode"   # the agent CLI (default: opencode); override
#                                  # to point the panel at a different binary
