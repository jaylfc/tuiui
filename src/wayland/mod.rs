//! Wayland compositor backend stubs.
//!
//! This module provides a Wayland compositor skeleton that integrates with tuiui's
//! TUI rendering pipeline. Actual Wayland protocol implementation and KMS/DRM
//! rendering will be added as the feature matures.
...
///
/// Sets desktop/session variables for child apps; leaves `WAYLAND_DISPLAY`
/// unset so it can be injected by the session manager when the socket is created.
